...
static const _CameraConfig_type_support_symbol_names_t _CameraConfig_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, shisen_interfaces, msg, CameraConfig)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, shisen_interfaces, msg, CameraConfig)),
  }
};
...
{
  return &::shisen_interfaces::msg::rosidl_typesupport_cpp::CameraConfig_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, shisen_interfaces, msg, CameraConfig)() {
  return get_message_type_support_handle<shisen_interfaces::msg::CameraConfig>();
}
