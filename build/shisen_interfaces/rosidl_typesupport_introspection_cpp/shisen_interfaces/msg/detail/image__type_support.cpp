...
{
  new (message_memory) shisen_interfaces::msg::Image(_init);
}

void Image_fini_function(void * message_memory)
{
  auto typed_message = static_cast<shisen_interfaces::msg::Image *>(message_memory);
  typed_message->~Image();
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Image_message_member_array[5] = {
  {
    ...
    offsetof(shisen_interfaces::msg::Image, cols),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(shisen_interfaces::msg::Image, rows),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(shisen_interfaces::msg::Image, channels),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(shisen_interfaces::msg::Image, quality),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(shisen_interfaces::msg::Image, data),  // bytes offset in struct
    nullptr,  // default value
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Image_message_members = {
  ...
  "Image",  // message name
  5,  // number of fields
  sizeof(shisen_interfaces::msg::Image),
...
{
  return &::shisen_interfaces::msg::rosidl_typesupport_introspection_cpp::Image_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, shisen_interfaces, msg, Image)() {
  return &::shisen_interfaces::msg::rosidl_typesupport_introspection_cpp::Image_message_type_support_handle;
}
