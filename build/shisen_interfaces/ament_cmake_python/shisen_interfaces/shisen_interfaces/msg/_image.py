...
class Metaclass_Image(type):
    ...
    @property
    def COLS__DEFAULT(cls):
        """Return default value for message field 'cols'."""
        return 320

    @property
    def ROWS__DEFAULT(cls):
        """Return default value for message field 'rows'."""
        return 240

    @property
    def CHANNELS__DEFAULT(cls):
        """Return default value for message field 'channels'."""
        return 3
...
class Image(metaclass=Metaclass_Image):
    ...
    def __init__(self, **kwargs):
        ...
        self.cols = kwargs.get(
            'cols', Image.COLS__DEFAULT)
        self.rows = kwargs.get(
            'rows', Image.ROWS__DEFAULT)
        self.channels = kwargs.get(
            'channels', Image.CHANNELS__DEFAULT)
        self.quality = kwargs.get(
            'quality', Image.QUALITY__DEFAULT)
