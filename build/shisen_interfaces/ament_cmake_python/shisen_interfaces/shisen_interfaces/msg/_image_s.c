...
bool shisen_interfaces__msg__image__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("shisen_interfaces.msg._image.Image", full_classname_dest, 34) == 0);
  }
  shisen_interfaces__msg__Image * ros_message = _ros_message;
  {  // cols
...
PyObject * shisen_interfaces__msg__image__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("shisen_interfaces.msg._image");
