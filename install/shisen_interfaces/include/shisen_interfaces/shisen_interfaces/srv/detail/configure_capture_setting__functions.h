...
#ifndef SHISEN_INTERFACES__SRV__DETAIL__CONFIGURE_CAPTURE_SETTING__FUNCTIONS_H_
#define SHISEN_INTERFACES__SRV__DETAIL__CONFIGURE_CAPTURE_SETTING__FUNCTIONS_H_
...
/// Initialize srv/ConfigureCaptureSetting message.
/**
...
/// Finalize srv/ConfigureCaptureSetting message.
/**
...
/// Create srv/ConfigureCaptureSetting message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * shisen_interfaces__srv__ConfigureCaptureSetting_Request__init().
...
/// Destroy srv/ConfigureCaptureSetting message.
/**
 * It calls
 * shisen_interfaces__srv__ConfigureCaptureSetting_Request__fini()
...
/// Check for srv/ConfigureCaptureSetting message equality.
/**
...
/// Copy a srv/ConfigureCaptureSetting message.
/**
...
/// Initialize array of srv/ConfigureCaptureSetting messages.
/**
...
/// Finalize array of srv/ConfigureCaptureSetting messages.
/**
 * It calls
 * shisen_interfaces__srv__ConfigureCaptureSetting_Request__fini()
...
/// Create array of srv/ConfigureCaptureSetting messages.
/**
...
/// Destroy array of srv/ConfigureCaptureSetting messages.
/**
 * It calls
 * shisen_interfaces__srv__ConfigureCaptureSetting_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/ConfigureCaptureSetting message array equality.
/**
...
/// Copy an array of srv/ConfigureCaptureSetting messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * shisen_interfaces__srv__ConfigureCaptureSetting_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_shisen_interfaces
...
/**
 * It calls
 * shisen_interfaces__srv__ConfigureCaptureSetting_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_shisen_interfaces
...
/**
 * It calls
 * shisen_interfaces__srv__ConfigureCaptureSetting_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * shisen_interfaces__srv__ConfigureCaptureSetting_Event__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_shisen_interfaces
...
/**
 * It calls
 * shisen_interfaces__srv__ConfigureCaptureSetting_Event__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_shisen_interfaces
...
/**
 * It allocates the memory for the array and calls
 * shisen_interfaces__srv__ConfigureCaptureSetting_Event__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_shisen_interfaces
...
/**
 * It calls
 * shisen_interfaces__srv__ConfigureCaptureSetting_Event__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // SHISEN_INTERFACES__SRV__DETAIL__CONFIGURE_CAPTURE_SETTING__FUNCTIONS_H_
